                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('products.update',['product'=>$record->id])}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input class="form-control" min="0" type="number" id="example-text-input" disabled
                                       name="discount"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" name="dimensions[height]" id="example-text-input" disabled
                                           required
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" name="dimensions[weight]" id="example-text-input" disabled
                                           required
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" name="dimensions[length]" id="example-text-input" disabled
                                           required
