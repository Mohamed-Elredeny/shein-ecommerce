...
<div class="shop-page2-area featured-products-area">
    <div class="container">
        <div class="row" dir="rtl">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h2 class="title-carousel">الفئات</h2>
            </div>
        </div>
        <div class="metro-carousel" data-loop="true" data-items="4" data-margin="30" data-autoplay="true"
            ...
            <div class="product-box4">
                <div class="product-content-holder2" dir="rtl">
                    <h3><a href="#">اسم الفئة</a></h3>
                    <span>50 منتج</span>
                    <br>
