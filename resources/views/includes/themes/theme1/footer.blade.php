                ...
                <div class="row" dir="rtl">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-box">
                            <h3>الفئات</h3>
                            <ul class="tag-list">
                                <li><a href="#">الفئة الاولي</a></li>
                                <li><a href="#">الفئة الثانية</a></li>
                                <li><a href="#">الفئة الثالثة</a></li>
                                <li><a href="#">الفئة الرابعة</a></li>
                                <li><a href="#">الفئة الخامسة</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-box">
                            ...
                            <ul class="info-list">
                                ...
                                <li><a href="#">كل الفئات</a></li>
                                <li><a href="#">كل المنتجات</a></li>
                                <li><a href="#">الخصوصية و الاحكام</a></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-box">
                            <h3>ايديا ارت للديكور</h3>
                            <p>ابدأ الان التسوق من عندنا
                                نضمن لك الجودة</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <p>© كل الحقوق محفوظة لدى ايديا ارت للديكور 2022</p>
                    </div>
